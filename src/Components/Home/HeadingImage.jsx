...
import bytewiseImage from '../../assets/images/bytewise.png'
import TechStore from '../../assets/images/techstore.jpg'
...
const HeadingImage = () => {
  ...
  return (
    <motion.div className="my-[83px] w-full " 
      initial="hidden"
      whileInView="visible"
      viewport={{ once: false }}
      variants={variants}>
        <div className="relative w-full ">
            <div className="bg-cover lg:h-[800px] h-[600px] bg-center relative rounded-[16px]" 
              style={{ 
