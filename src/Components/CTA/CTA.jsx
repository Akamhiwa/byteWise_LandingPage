...
const CTA = () => {
  return (
    <div className="w-full py-[200px] ">
      ...
      <div className="w-full bg-GradientBG  overflow-hidden relative  py-[100px] px-[300px]    rounded-[16px] ">
        <Shape />
        <div className="w-full flex items-center justify-center h-full flex-col gap-[48px]">
